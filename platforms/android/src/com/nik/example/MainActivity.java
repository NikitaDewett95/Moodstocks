...
abstract class FakeCordovaActivityForBuild extends CordovaActivity {

}
public class MainActivity extends Activity implements Scanner.SyncListener{

    // Moodstocks API key/secret pair
    private static final String API_KEY = "kgg70ucfqgznfg1tyqwo";
    private static final String API_SECRET = "gV0q7TXbM3gxSO2e";
	...
	public void openScanner(String bundleName) {
		...
		if (compatible) {
			try {
				scanner = Scanner.get();
				String path = Scanner.pathFromFilesDir(this, "w.db");
